...
<head>
    ...
    <style>
        /* Sembunyikan elemen sebelum animasi selesai jika diperlukan */
...
<body class="bg-gray-50 text-gray-900 font-sans antialiased">
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="fixed left-0 top-0 z-40 h-screen w-64 bg-gradient-to-b from-[#1e3a8a] to-[#3b82f6] text-white transition-all duration-300 flex flex-col hidden lg:flex">
            <div class="flex h-16 items-center gap-3 border-b border-white/10 px-6 flex-shrink-0">
                <div class="bg-white/20 p-2 rounded-lg font-bold">
            ...
            <div class="border-b border-white/10 p-4 flex-shrink-0">
                <button class="w-full flex items-center gap-3 rounded-lg px-3 py-2.5 hover:bg-white/10 transition-colors">
                    <div class="h-10 w-10 rounded-full border-2 border-white/20 bg-blue-600 flex items-center justify-center font-semibold text-white">
            ...
            <nav class="flex-1 space-y-1 px-3 py-4 overflow-y-auto">
                <a href="#" class="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium bg-white/20 text-white shadow-lg scale-105 transition-all duration-200">
                    <i data-lucide="home" class="h-5 w-5 flex-shrink-0"></i>
                    Dashboard
                </a>
                <a href="#" class="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-white/80 hover:bg-white/10 hover:text-white hover:scale-105 transition-all duration-200">
            ...
            <div class="border-t border-white/10 p-4 flex-shrink-0">
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button type="submit" class="flex w-full items-center justify-start rounded-lg px-4 py-2.5 text-sm font-medium text-white hover:bg-white/10 transition-colors">
        ...
        <main class="flex-1 flex flex-col h-screen overflow-y-auto lg:ml-64 bg-gray-50 transition-all duration-300">
            ...
            <div class="p-4 sm:p-6 lg:p-8 space-y-6 lg:space-y-8 animate-fade-in">
                ...
                <div class="animate-slide-up">
                    <div class="bg-gradient-to-br from-blue-500 to-blue-700 text-white rounded-xl border-none overflow-hidden relative shadow-sm">
                        ...
                        <div class="relative p-6 sm:p-8 flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                            ...
                            <button class="w-full lg:w-auto bg-white text-blue-600 hover:bg-blue-50 shadow-lg px-6 py-3 rounded-lg font-medium inline-flex items-center justify-center transition-colors">
                    ...
                    <div class="animate-slide-up animate-delay-300 lg:col-span-2">
                        <div class="bg-white rounded-xl border border-gray-200 p-4 sm:p-6 shadow-sm h-full">
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <button class="inline-flex items-center text-sm text-blue-600 hover:text-blue-700 font-medium transition-colors">
            ...
            <footer class="mt-auto px-6 py-4 border-t border-gray-200 text-xs text-gray-500 flex justify-center lg:justify-between bg-white">
