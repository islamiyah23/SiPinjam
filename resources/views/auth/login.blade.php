...
<style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .toggle-btn.active { background: #2563eb; color: #fff; box-shadow: 0 2px 8px rgba(37,99,235,0.35); }
    ...
    .remember-label input[type="checkbox"] { width: 16px; height: 16px; accent-color: #2563eb; cursor: pointer; }
    .remember-text { font-size: 13px; color: #6b7280; font-weight: 500; }
    .forgot-link { font-size: 13px; font-weight: 600; color: #2563eb; text-decoration: none; }
    ...
    .btn-primary {
        ...
        transition: background 0.2s, transform 0.1s, box-shadow 0.2s; letter-spacing: 0.01em;
    }
    ...
    .demo-box { background: #f9fafb; border: 1px solid #e5e7eb; border-radius: 10px; padding: 14px 16px; font-size: 13px; color: #6b7280; line-height: 1.85; margin-top: 20px; }
    .demo-box strong { color: #374151; font-weight: 700; }
...
<div class="left-panel">
    ...
    <div class="left-footer">© 2025 SIPINJAM. Universitas Indonesia.</div>
</div>

<div class="right-panel">
    <div class="form-card">
        <div class="form-header">
            <h2 class="form-title">Masuk ke SIPINJAM</h2>
            <p class="form-subtitle">Masukkan email dan password Anda untuk melanjutkan</p>
        </div>

        <div class="role-toggle">
            <button type="button" class="toggle-btn active" id="btn-user" onclick="setRole('user')">User</button>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="field-group">
                ...
                <input id="email" type="email" name="email" value="{{ old('email') }}" class="form-input" placeholder="nama@sipinjam.ac.id" required autofocus autocomplete="username" />
        ...
        <div class="demo-box">
            ...
            User: user@sipinjam.ac.id<br>
            Admin: admin@sipinjam.ac.id<br>
