...
<div class="flex h-screen overflow-hidden">
     ...
     {{-- SIDEBAR --}}
        ...
        <nav class="flex-1 space-y-1 px-3 py-2 overflow-y-auto">
            ...
            <a href="{{ route('ruangan.index') }}" class="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium bg-white/20 text-white shadow-sm scale-105 transition-all duration-200">
